            ...
            res.status(200)
                .json({
                    ...
                    data: {
                        ...
                        dropshipper_address: headerInvoice.dropshipper_address,
                        dropshipper_phone: headerInvoice.dropshipper_phone,
                        dropshipper_email: headerInvoice.dropshipper_email,
                        sales_person: headerInvoice.sales_person,
                        dropshipper: headerInvoice.dropshipper,
                        dropshipper_first_name: headerInvoice.dropshipper_first_name,
                        dropshipper_last_name: headerInvoice.dropshipper_last_name,
