...
class ProductV3Controller {
    index = (req, res) => {
        ...
        ProductService.getProduct(req.query, partnerGroupId, 'N', 'N')
        .then(result => {
            res.status(200)
                .json({
                    status: 'success',
    ...
    detailFlashSale = async (req, res) => {
        try {
            ...
            let dataPrice = await PriceService.getPrice(dataProduct.dataValues.product_id, dataProduct.dataValues.pt_en_id, partnerGroupId, 'Y', 'N')
    ...
    detailAotherProgram = async (req, res) => {
        try {
            ...
            let dataPrice = await PriceService.getPrice(dataProduct.dataValues.product_id, dataProduct.dataValues.pt_en_id, partnerGroupId, 'N', 'Y')
